 ...
 */
class Test_subscriber_action_listener : public virtual mqtt::callback,
  ...
  void message_arrived(mqtt::const_message_ptr msg) override {
    ...
    int return_value = pt.get<int>("response");
    std::cout << "\n[Test_subscriber_action_listener::" << __func__ << "\nfilename: " << filename << "\nreturn value: " << return_value << std::endl;
